            ...
            <div className="space-y-6">
              <div className="border-t border-gray-700 pt-4">
                ...
                <div className="mb-4 p-3 bg-gray-800/50 border border-gray-600 rounded-lg">
                  ...
                  <div className="text-sm text-gray-300 mt-1">
                    <strong>Processing Time:</strong> <span className="text-purple-400">{orchestrationResult.workflow_summary.processing_time}s</span>
                  </div>
                </div>
                ...
                {/* Agent Details */}
                <div className="space-y-2">
                  <h4 className="text-md font-semibold text-white">Agents Used:</h4>
                  <div className="space-y-2">
