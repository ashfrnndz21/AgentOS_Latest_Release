...
python services/utility_agents/database_agent_service.py >utility_database.log 2>&1 &
DATABASE_AGENT_PID=$!
cd ..
...
cd backend
source venv/bin/activate
python services/utility_agents/synthetic_data_service.py >utility_synthetic.log 2>&1 &
SYNTHETIC_DATA_PID=$!
cd ..
...
cd backend
source venv/bin/activate
python services/utility_agents/utility_orchestration_engine.py >utility_orchestration.log 2>&1 &
...
cd backend
source venv/bin/activate
python services/utility_agents/utility_api_gateway.py >utility_gateway.log 2>&1 &
API_GATEWAY_PID=$!
cd ..
